        ...
        <div class="col-md-6 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-horizontal" method="post" action="{{ route('datatamu.store') }}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 form-group">
                                        ...
                                        class="form-control" @error('kepentingan') is invalid
                                        @enderror
                                    ...
                                    <div class="col-md-8 form-group">
                                        ...
                                        class="form-control" @error('tanggal_bertamu') is invalid
                                        @enderror
                                        value="{{ old('tanggal_bertamu') }}"
                                        placeholder="">
